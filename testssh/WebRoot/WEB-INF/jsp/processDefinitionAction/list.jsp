...
<script type="text/javascript">
	function showProcessImage(pdId) {
		...
		if(navigator.userAgent.indexOf("Chrome") >0 ){
			var winOption = "height=500px,width=600px,top=50,left=50,toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,fullscreen=0";
			    	return  window.open(url,window, winOption);
			}
			else{
			    return 	window.showModalDialog(url, null, "dialogHeight:500px;dialogWidth:600px;resizable:yes");
			}
...
<body>
	...
	<div class="Description">
		说明：<br /> 1，列表显示的是所有流程定义（不同Key）的最新版本。<br />
		2，删除流程定义时，此Key的所有版本的流程定义都会被删除。<br /> 3，查看流程图时显示的这个最新版本的流程定义的图片。
	</div>
